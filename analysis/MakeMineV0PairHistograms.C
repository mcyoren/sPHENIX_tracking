  ...
  const Long64_t maxEntries = -1)
{
  ...
  const std::vector<Selection> selections = {
    ...
    {
      "cut04_pairDCA_15mm",
      "|z|<12, pt>0.30, dz<0.40, pairDCA<1.5",
      12.0, 0.50, 0.30, 6.0, 0.80, 1.50, 0.88, 15.0, 30
    },
    {
      "cut05_pairDCA_10mm",
      "|z|<10, pt>0.30, dz<0.30, pairDCA<1.0",
      10.0, 0.40, 0.30, 6.0, 0.75, 1.00, 0.90, 13.0, 30
    },
    {
      "cut06_pairDCA_7mm",
      "|z|<10, pt>0.3, dz<0.25, pairDCA<0.7",
      10.0, 0.25, 0.3, 7.0, 0.75, 0.70, 0.93, 12.0, 32
    },
    {
      "cut07_pairDCA_5mm",
      "|z|<10, pt>0.30, dz<0.20, pairDCA<0.5",
      10.0, 0.20, 0.30, 7.0, 0.70, 0.50, 0.95, 10.0, 32
    },
    {
      "cut08_pairDCA_3mm",
      "|z|<8, pt>0.30, dz<0.15, pairDCA<0.3",
      8.0, 0.15, 0.30, 8.0, 0.70, 0.30, 0.98, 8.0, 35
    },
    {
      "cut09_pairDCA_2mm",
      "|z|<8, pt>0.20, dz<0.10, pairDCA<0.2",
      8.0, 0.10, 0.20, 8.0, 0.65, 0.20, 0.99, 6.0, 35
    }
  };
