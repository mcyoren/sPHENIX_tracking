// MakeK0s2DClusterCorrectionVotes_v2.C
//
...
//
// Example:
// root -l -b -q 'MakeK0s2DClusterCorrectionVotes_v2.C(
...
void MakeK0s2DClusterCorrectionVotes_v2(
    const char* inputDirectory = ".",
    const char* filePattern = "*.root",
    const char* outputName = "k0s_2d_cluster_votes_cut03.root",
